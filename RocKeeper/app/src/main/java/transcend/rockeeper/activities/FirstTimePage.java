    ...
    public void launchMainPage(View view) {
    	...
    	Transaction t = new Transaction(db){
			public void task(SQLiteDatabase db) {
		    	...
		    	Route r1 = dbh.routes.build("v0", 2, 1, 0xFF00FF00, "Rainbow Road");
		    	Route r2 = dbh.routes.build("v3", 0, 1, 0xFFFF0000, "Death Drop");
		    	Route r3 = dbh.routes.build("v2", 1, 1, 0xFF0000FF, "Inner Peaks");
